...
// ab binary search lga lete hai
// ll lo=0,hi=1e6;
// while(lo<=hi)
// {
//     ll mid=lo+(hi-lo)/2;
//     double x1=mid*2;
//     double t1=(h*(x1+1)+c*(x1))/(4*mid+1);
//     double t2=(h*(x1)+c*(x1-1))/(4*mid-1);
//      double diff1=abs(t-t1);
//      double diff2=abs(t-t2);
